...
TCPA_PATH="/scratch-local/zhouji/grlib-com-l2c-1.4.3-b4160/designs/leon3-minimal/tcpa_component"
...
vcom -quiet  -93  -work work data_type_pkg.vhd      # package compile
...
vcom -quiet -explicit -O0 $TCPA_PATH/TOP/TCPA_TOP_2018.vhd
vcom -quiet  -93  -work work  leon3mp.vhd



####################   test amba_interface with single component
#vcom -quiet  -93  -work work $GRLIB_PATH/designs/leon3-minimal/test_connection_only/data_type_pkg.vhd
#vcom -quiet  -93  -work work $GRLIB_PATH/designs/leon3-minimal/test_connection_only/single_comp.vhd
#vcom -quiet  -93  -work work $GRLIB_PATH/designs/leon3-minimal/test_connection_only/amba_interface.vhd  
#vcom -quiet  -93  -work work $GRLIB_PATH/designs/leon3-minimal/test_connection_only/test_top.vhd
